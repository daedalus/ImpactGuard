...
from impactguard.cst_patch import (
    patch_function, patch_call,
)
from impactguard.patch_confidence import (
    compute_confidence, classify as classify_patch,
...
from impactguard.trace_calls import install_tracer, dump, COUNTS
from impactguard.trace_calls_prod import (
    should_sample, flush, install_tracer as install_tracer_prod,
)
...
def test_impact_analysis_final():
    ...
    calls_data2 = [{"fqname": "test.py:bar", "args": 100, "file": "caller.py", "lineno": 20}]
